    ...
    public class GapRule : IPattern
        ...
        public void add(Bar bar)
            ...
            if (m_bars.Count >= m_minimumBars)
                ...
                if(m_bars[0].High < m_bars[1].Low && ClosesInTopQuarter(m_bars[1]) && ClosesInTopQuarter(m_bars[2]))
                    m_sentiment = Sentiment.BULLISH;
                else if(m_bars[1].High < m_bars[0].Low && ClosesInBottomQuarter(m_bars[1]) && ClosesInBottomQuarter(m_bars[2]))
